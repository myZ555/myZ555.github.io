...
4. Determinants of vascular tone (relax)
	...
	4. increasing cAMP
5. Treatments: Drugs used in angina pectoris
	- **Nitrates & Nitrites, eg, nitroglycerin;**
	- **β-blockers;**
	- **calcium channel blockers;**
	- **ACEIs、ARBs**
	- Anti-platelet agents;
	- fatty acid oxidation inhibitors (under Preliminary clinical trials)
	- Fish oil
---
...
- 硝酸甘油在肝内经谷胱甘肽 - 有机硝酸酯 还原酶还原成水溶性较高的二硝酸代谢物
---
###### 2. Pharmacological effects

1. 改变血流动力学，降低心肌耗氧量
	- Dilate the vein at low dose → ↓preload
	- Reducing wall tension → ↓contraction duration
	- Dilate the artery at high dose → ↓afterload
	- By reflex, increase the HR and contractility
2. 改变心肌血液分布，增加缺血区血液灌流
	- Decrease left ventricular filling pressure → increase blood supply
	- Dilate the coronary blood vessel （扩张非缺血区较大的 输送血管，增加血供）and increase blood supply（冠状 动脉痉挛时更为明显，而对阻力血管的舒张作用较弱）
	- Dilate collateral circulation to increase blood supply to ischemic areas
3. 保护缺血的心肌细胞，减轻缺血性损伤，防治并发症
	- NO → PGI 2 , CGRP (降钙素基因相关肽）production ↑
4. 抑制血小板聚集
---
...
- 耐受: 受剂量、频率、药物剂型和给药途径相关，不同药物之间有交叉耐受
	- 1）血管机制，decrease in tissue sulfhydryl groups (decrease of NO), it can be only partially reversed with a sulfhydryl-regenerating agent, such as Vit C, methylamine, N- acetyl-cysteine
	- 2）非血管机制，Sympathetic discharge and retention of salt and water may also be involved。
	- 预防：To avoid tolerance, a nitrate-free period of at least 8 hours between doses should be observed to reduce or prevent tolerance.
- Carcinogenicity （Some Nitrosamines（亚硝胺） formed from the combination of nitrates and nitrites with amines are powerful carcinogens in animals.）
---
### 2.  β blockers
...
1. 降低心肌耗氧量
	- 拮抗心肌细胞β1 受体，心肌收缩力减弱、心率减慢、心室舒张时间延长和血压降低
	- *反射性*：心室容积增加，心室前负荷增加，同时因收缩力 减弱，心室射血时间延长，导致心肌*耗氧量增加*
2. 改善心肌缺血区供血
	- 缺血区代谢变化舒张血管，而非缺血区血管阻力相对增高
	- 缺血区的血管舒张，血管阻力降低
	- 心率降低，心舒张期相对延长，促进缺血区侧枝循环开放，增加缺血区的血液灌注
3. 改善心肌代谢
	- 抑制脂肪分解酶的活性，减少心肌游离脂肪酸的含量
	- 改善心肌缺血区对葡萄糖的摄取和利用，改善糖代谢，保 护线粒体，增加能量供应。
4. 促进氧合血红蛋白解离，增加组织供氧
---
###### 2. 临床应用

- Decrease mortality of patients with recent *myocardial infarction* and improve survival and prevent stroke in patients with *hypertension*.
- Randomized trials in patients with *stable angina* have shown better outcome and symptomatic improvement with β-blockers compared with calcium channel blockers.
- 对冠状动脉痉挛*诱发的变异型心绞痛不宜应用*，因其阻断冠状血管β2 受体，导致α1 受体作用相对占优势，加重冠状动脉收缩
---
###### 3. 不良反应

- Increase in end-diastolic volume and an increase in ejection time-------can be balanced by the concomitant use of nitrates.
- *Contraindications,* asthma and other bronchospastic conditions, severe bradycardia, atrioventricular blockade, bradycardia-tachycardia syndrome, and severe unstable left ventricular failure
- *Potential complications* ， fatigue, impaired exercise tolerance, insomnia, unpleasant dreams, worsening of claudication, and erectile dysfunction
...
|                         | Nitrates alone | β blockers/CCB | combined nitrates + β blockers/CCB |
| ----------------------- | -------------- | -------------- | ---------------------------------- |
| Heart rate              | reflex ↑       | ↓              | ↓                                  |
| Arterial pressure       | ↓              | ↓              | ↓                                  |
| End-diastolic<br>volume | ↓              | ↑              | N/↓                                |
| Contractility           | reflex ↑       | ↓              | N                                  |
| Ejection time           | ↓              | ↑              | N                                  |
...
###### 曲美他嗪（trimetazidine）
- 抑制脂肪酸氧化，促进葡萄糖氧化，维持心肌 细胞在缺血缺氧情况下的能量代谢。
- 主要用于心绞痛发作的预防。
###### 伊伐布雷定（ivabradine ）
- If 电流选择性抑制剂，通过减慢心率，降低心肌 耗氧量。
- 用于不能耐受β 受体阻断药或者应用β 受体阻断 药后心率仍＞60 次/min 的稳定型心绞痛患者。
###### 尼可地尔（Nicorandil ），吡那地尔（Pinacidil），克罗卡林（Cromakalim）
- K+开放剂，促进K+外流，使细胞膜超极化，抑制Ca 2+ 内流。
- 释放NO，松弛血管平滑肌，包括冠脉血管
- 用于变异型心绞痛、慢性稳定型心绞痛
- 不易产生耐受性。
###### ACEI和ARB
- 扩张动、静脉血管减低心脏前后负荷，从而降低心脏 耗氧量。
- 舒张冠状血管增加心肌供氧。
- 抗自由基
- 保护心肌细胞、抗心脏与血管的重构
---
...
#### Angina of Effort
- For **maintenance therapy** of chronic stable angina, long-acting nitrates, calcium channel- blocking agents, or β - blockers may be chosen. Individual therapy is demanded.
- In **hypertensive patients**, monotherapy with either slow-release or long-acting calcium channel blockers or β-blockers.
