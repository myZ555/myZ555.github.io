...
![[Pasted image 20251202102834.png|400]]
...
![[Pasted image 20251202103039.png|500]]![[Pasted image 20251202103053.png|500]]
- 额面六轴系统：以上6个导联的轴一并通过坐标图轴的中心点。左侧为0°，顺时钟为正向。每个相邻导联夹角30°
#### 2. 胸导联 V1-V6
![[Pasted image 20251202103407.png|500]]
- 附加导联：V7-9，V3R-V5R
	- 后壁心肌梗死：V7-V9
	- 右心病变/小儿心电图：V3R-V5R
# 二、心电图的测量和正常数据
![[Pasted image 20251202103602.png|500]]
- 心电图纸：
...
- 判断偏向：
	...
	- Ⅰ负Ⅲ正-------右偏（尖对尖）【90~180°】
	- Ⅰ正Ⅲ负-------左偏（口对口）【-90°~-30°】
![[Pasted image 20251202105233.png|260]]![[Pasted image 20251204100336.png|350]]
#### 4. 间期
【形状和宽度】
- P波大小： ^fa41a8
	- 值：正常≤0.12s
...
1. P波增宽≥0.12s，常呈双峰，峰距≥0.04s
	- ![[Pasted image 20251204100221.png|200]]
2. PtfV1≤0.04mm·s
...
# 五、心肌梗死
## （一）基本图形及机制
![[Pasted image 20251204084041.png|450]]
1. “缺血型”改变：T波改变（倒置）
2. “损伤型”改变：ST段弓背抬高
3. “坏死型”改变：病理性Q波
*振幅≥1/4R，时限≥0.04s*
## （二）心肌梗死的心电图演变及分期
![[Pasted image 20251204084105.png|500]]
1. 超急性期
2. 急性期
3. 亚急性期
4. 陈旧期
...
| 正后壁  | V7-V9           |
| 右室   | V3R-V5R         |
![[Pasted image 20251204085011.png|270]]![[Pasted image 20251204085023.png|300]]
> [!NOTE]
> ==冠状动脉解剖==
> ├── *右冠状动脉* (RCA)
> │   ├── 锐缘支 (AM)
...
>![[Pasted image 20251202111109.png|400]]
...
>![[Pasted image 20251204093249.png]]
...
- 房室结双径路：在房室交界区域存在两条传到性能不同的径路（一快一慢）
	- *慢径路α*：传导速度慢，不应期短
	- *快径路β*：传导速度快，不应期长
- 折返：先从α下行，到达AV结之后，下传心室+沿β逆行回心房。**α下β上**![[Pasted image 20251204095024.png|350]]
##### 6. 房室折返性心动过速 AVRT
【顺向型房室折返性心动过速】
...
---
### 房室传导阻滞
![[Pasted image 20251204091837.png|500]]
> 有效不应期ERP：无法传递电信号
...
- 文氏周期反复出现
![[Pasted image 20251204092700.png|500]]
###### Ⅱ°Ⅱ型
- ERP大幅延长，RRP缩短。-->A-V结的性质变为全或无
==ECG：==
- *PR间期正常且固定*，部分P波后无QRS波群
![[Pasted image 20251204092814.png|500]]
#### 三度A-V阻滞
- 整个心动周期全为有效不应期
==ECG：逸搏心律==
...
![[Pasted image 20251204092954.png|500]]
---
### 室内传导阻滞

#### 右束支传导阻滞 RBBB
右束支细而长，由单侧冠脉分支供血，容易缺血。其不应期比左束支长，故传导阻滞多见
![[Pasted image 20251204094104.png|240]]![[Pasted image 20251204094134.png|400]]
#### 左束支传导阻滞
左束支粗而短，由双侧冠状动脉分支供血，不易发生传导阻滞。若发生多为器质性病变
![[Pasted image 20251204094305.png|200]]
...
2. 低血钾
3. 高血钙和低血钙
![[Pasted image 20251204100651.png]]
### （二）药物影响
1. 洋地黄对心电图的影响
	1. 洋地黄效应
	2. 洋地黄中毒
